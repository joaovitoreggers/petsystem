...
const SEED_WORK_PERMITS = [
  ...
  { id: 'PET-2026-0416', areas: ['confinado', 'altura'], location: 'Casa de caldeiras 02 · Matelândia', unit: 'Matelândia', teamSize: 4, date: '2026-09-05', start: '07:30', end: '', timeLabel: '07:30', technician: 'B. Garlini', status: 'aberta' as const, coordinates: '-25.2540, -53.9911', gas: { o2: 20.9, co: 14, h2s: 0, lel: 4 } },
  ...
  { id: 'PET-2026-0412', areas: ['confinado'], location: 'Moega de recebimento 01 · Missal', unit: 'Missal', teamSize: 5, date: '2026-09-02', start: '14:10', end: '14:36', timeLabel: '02/09', technician: 'A. Beal', status: 'ocorrencia' as const, coordinates: '', durationMinutes: 26 },
  ...
  { id: 'PET-2026-0405', areas: ['maquinas'], location: 'Oficina de manutenção · Matelândia', unit: 'Matelândia', teamSize: 2, date: '2026-08-28', start: '13:40', end: '16:10', timeLabel: '28/08', technician: 'B. Garlini', status: 'fechada' as const, coordinates: '', durationMinutes: 150 },
